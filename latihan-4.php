    ...
    <form action="#" method="post" enctype="multipart/form-data">
      ...
      <table border="1" align="center" celpadding="5" cellspacing="1">
        ...
        <tr>
          ...
          <td><input type="text" name="nrp" placeholder="isikan nrp.."required />
          <br><span style='color:red'><?= $errornrp??'' ?></span></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <br><span style='color:red'><?= $errortgl??'' ?></span></td>
        </tr>
        <tr>
            ...
            <td>
              ...
              <br><span style='color:red'><?= $errorjk??'' ?></span></td>
